...
```=Week 4: Jacob Works for Uncle Laban
...
Recycled cardboard, blue paper, craft sticks, paper cups, cardboard cylinders, masking tape, craft glue, scissors, toy cars (optional).

```

```=Week 6: Joseph’s Coat and Dreams
...
```=Week 8: Joseph: A Slave in Egypt
...
```=Week 9: Joseph: From Prison to Palace
...
```=Week 10: Joseph: Governor of Egypt
