...
markdownTitle: '^[Craft Resources]({"style": {"text": {"color": "#F4793B"}}})'
---

```=Week 1: Two Birth Announcements
...
```=Week 2: The Gift of Jesus

**Baby Jesus in a Manger**

![Sample](2c.png)

**Resources/supplies:** Craft sticks, a piece of cardstock 4-1/3 inches by 3-1/2 inches (11 centimeters by 9 centimeters), craft glue, oval-shaped rocks,

```

black markers, pieces of fabric, rubber bands, straw.

```=Week 3: Worshipping Baby Jesus
...
```=Week 4: Keeping Baby Jesus Safe
...
```=Week 7: Victory in the Wilderness
...
```=Week 10: Jesus Feeds the Crowds
...
```=Week 13: Blessings in Capernaum
