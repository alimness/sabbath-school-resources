...
Source **a piece of paper** and **pencil** for each child and a **timer**.
...
Source **flashlight**, **broom**, **blanket** and **pillow**, **baby doll**, **paper** (or writing tablet) and **pen**. Also, source **peg people** and **angel**, **blocks** to use as extra peg people (John’s family and friends), **felt set**, if available.
...
- Globe or world map
- Offering container
- Bible characters or actions on slips of paper, container
- “Lord, Please Guide Me” lyrics to display
- Timer
- Small pieces of paper and pencils
- Long rope, ribbon, floor markers for tug-of-war
- Peg people/blocks to use as peg people, flashlight, felt set, broom, blanket and pillow, baby doll, paper (or writing tablet), pen
