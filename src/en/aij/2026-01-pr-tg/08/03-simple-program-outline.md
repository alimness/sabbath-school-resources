...
- Pray: Circle of thanks
- Bible Focus: Sing “Books of the Bible” and share Bible Fast Fact.
...
- Activity and Discussion: Objects that protect us
- Picture: Ark on rough sea
- Share the **^[Big Idea: I can thank God for His protection and trust all His promises.]({"style": {"text": {"color":"#e6b349"}}})**
...
- Activity: **^[Patience rating scale (1-10)]({"style": {"text": {"color":"#649b7c"}}})**
...
- Activity: Imagine what it might have been like to leave the ark.
- Thank God for things that match the different colors of the rainbow.
...
- **^[Character Card 8: Rainbow Promise]({"style": {"text": {"color":"#a771b0"}}})**
- **^[Memory Verse and Scripture Song:]({"style": {"text": {"color":"#a771b0"}}})** “Psalm 57:1”
- **^[Nature Lesson:]({"style": {"text": {"color":"#a771b0"}}})** “Cheetah Protects Her Cubs”
- **^[Craft:]({"style": {"text": {"color":"#a771b0"}}})** Promise and Protection Spinner
...
- Pray.
- Take Home: Extra **^[Character Card 8: Rainbow Promise]({"style": {"text": {"color":"#a771b0"}}})**