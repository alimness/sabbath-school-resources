...
- Bookmark Bible texts for children to read during story time.
- Angel craft
...
- Pray: Invite the children to share answered prayers, and ask two volunteers to pray, including giving thanks.
...
- Review Sabbath challenge from previous week.
- Share the **^[Big Idea: God gives me freedom to choose because He is love.]({"style": {"text": {"color":"#e6b349"}}})**
...
- Object lesson: **^[Weed roots]({"style": {"text": {"color":"#00b7aa"}}})**—pride grows deep roots
- Object lesson and discussion: Heated hearts
...
- Commit: Write choices in heart-shaped cutouts.
