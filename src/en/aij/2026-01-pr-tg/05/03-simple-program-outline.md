...
- Predict Garden of Eden story characters.
- Object Lesson: Introduce remote-controlled vehicle
- Share the **^[Big Idea: When I make a wrong choice, God still loves me and has a plan to save.]({"style": {"text": {"color":"#e6b349"}}})**
...
- Activity and discussion: Remote-controlled vehicle—reason for freedom of choice
...
- Activity and discussion: Using a broken plate demonstrate how sin breaks, but God mends.
...
- **^[Character Card 5: The Promise]({"style": {"text": {"color":"#a771b0"}}})**
- **^[Memory Verse and Scripture Song:]({"style": {"text": {"color":"#a771b0"}}})** “Psalm 86:5”
- **^[Mission Story:]({"style": {"text": {"color":"#a771b0"}}})** “Choosing Jesus”
- **^[Craft:]({"style": {"text": {"color":"#a771b0"}}})** Storytelling Cube
...
- Commit: Do you want to choose God this week?
- Pray.