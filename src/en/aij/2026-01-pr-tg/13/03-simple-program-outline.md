...
- Activity
- Share the **^[Big Idea: I can wait patiently for God’s promises to be fulfilled, because God is faithful.]({"style": {"text": {"color":"#e6b349"}}})**
...
- {"style": {"block": {"backgroundColor": "#FFFCF6", "padding": {"top": "sm", "start": "base", "end":"sm", "bottom": "sm"}}}}
- Discussion: Reason for reminders
- Activity: **^[Promise rotation]({"style": {"text": {"color":"#649b7c"}}})**
- Apply: Promise box
...
- Object lesson and discussion: **^[Two balloons]({"style": {"text": {"color":"#00b7aa"}}})**; God can do the impossible.
...
- **^[Character Card 13: Baby Isaac]({"style": {"text": {"color":"#a771b0"}}})**
- **^[Memory Verse and Scripture Song: “Hebrews 10:23”]({"style": {"text": {"color":"#a771b0"}}})**
- Option: Find/order memory verse words.
- **^[Mission Story:]({"style": {"text": {"color":"#a771b0"}}})** “Praying for a Baby”
- Review: Partner sharing with music
- **^[Craft:]({"style": {"text": {"color":"#a771b0"}}})** Christian Hospitality Coloring Book
- Sing **^[“God Bless You.”]({"style": {"text": {"color":"#a771b0"}}})**
- **^[Mission Challenge:]({"style": {"text": {"color":"#a771b0"}}})** Put service suggestions from craft into practice to serve another family.
- Pray.