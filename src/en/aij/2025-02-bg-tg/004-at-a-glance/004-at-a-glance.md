...
- Leaf branches, sticks
- Wooden blocks and people
- Cardboard house and cups
- Large stones
- Plastic sifter and sorting cups
- Toy doctor kit
...
- {"style": {"block": {"backgroundColor": "#F8F7F6", "padding": {"top": "sm", "start": "xl", "end":"sm", "bottom": "sm"}}}}
- Toy colorful fish or shapes
- Toy ocean animals and shells
- Small toy boats, sponges, or containers
- Large stones
...
**Create a bright, nature-themed decorated box and fill with a different nature object of your choice each week.**
...
Draw some pictures on the bag too that represent the miracles of Jesus (fish, bread, etc.), if desired.

See the “Interactive Bible Story Suggestions” for specific weekly items to place inside the Bible story bag.
...
- Toddler musical instruments, if desired
- Mirrors
- Toy or paper fish on rods
- World ball to roll to each other in a circle
- Laminated footprints or stepping blocks
- Ribbons to wave
- Bubbles to blow
- Doll or selected toys for sharing song
- Piece of colorful fabric