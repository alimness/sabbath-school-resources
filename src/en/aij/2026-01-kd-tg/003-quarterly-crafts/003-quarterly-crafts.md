...
**Resources/supplies:** White cardstock, green paper strips, colored fabrics, colored tissue paper, craft glue, and scissors. 

**Option 2**

![Sample](https://sabbath-school-resources-assets.adventech.io/en/aij/2026-01-kd-tg/03/3b2.png)

**Resources/supplies:** small glass jars, acrylic paints, paintbrush, water, and smocks (to cover clothing).

```

```=Week 4: Lucifer’s Sad Choice
