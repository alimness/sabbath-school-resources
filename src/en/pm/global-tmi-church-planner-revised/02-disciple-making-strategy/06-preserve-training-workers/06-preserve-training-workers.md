---
title: "Preserve: Training Workers"
subtitle: New Member Discipleship Ministry
---

### Preserve the Harvest

After the joy of the harvest, we must not relax our disciple-making efforts. Jesus called us to make disciples, not mere members. To do so requires that we ^[PRESERVE]({"style":{"text":{"typeface": "Gibson-SemiBold"}}}) the harvest through nurture and training after baptism. For the disciple-making process to result in multiplication, we must teach newly baptized church members how to labor for souls. The consumer must become a producer. The one caught by the gospel net must become a fisher of men.

{"style":{"block":{"backgroundColor": "#EECCCD","rounded": true, "padding": {"top":"base","bottom":"base","start":"base","end":"base"}}}}
“A disciple is not above his teacher, but everyone who is ^[perfectly trained]({"style":{"text":{"typeface": "Gibson-SemiBold"}}}) will be like his teacher” (Luke 6:40).
“Then Jesus said to them, ‘Follow Me, and ^[I will make you]({"style":{"text":{"typeface": "Gibson-SemiBold"}}}) become fishers of men’ ” (Mark 1:17).
