...
- In 1903, W. H. Anderson, Jacob Detcha, and several African workers set out to Northern Rhodesia (now Zambia) to find a new mission site. They traveled by train and then on foot to Victoria Falls.
- Zambia has four secondary schools and a college (Rusangu University) for Adventist students. There are also two Adventist hospitals and two clinics in Zambia.

```

```=Fast Facts

- The traditional name for Victoria Falls is Mosi-oa-Tunya, which means the “Smoke that Thunders.” They say that the noise can be heard from as far as 25 miles (40 km) away.
- One third of Zambia is made up of national parks.
